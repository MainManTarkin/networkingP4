...
#-v means begin running in valgrind (only works if run now arg is called)
#-i provide input c++ files for g++ defaults to testMain.cpp

while getopts "i:o:a:vr" options; do         # Loop: Get the next option;
